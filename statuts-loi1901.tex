...
% Variables
\def\nomAssociation{} % Nom complet de l'association
\def\adresseAssociation{} % Adresse complète du siège social de l'association
\def\objetAssociation{} % Objet social de l'association
\def\dateStatuts{} % Date de signature des statuts

\def\tailleCA{} % Taille du Conseil d'Administration
\def\dureeMandatCA{} % Durée du mandat au Conseil d'Administration, en années
